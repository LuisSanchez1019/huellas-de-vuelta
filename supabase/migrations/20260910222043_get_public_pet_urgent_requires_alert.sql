-- La linea "requiere medicamento urgente" solo puede aparecer si tambien se
-- autorizo la alerta medica general. medical_urgent pasa a exigir
-- public_alert_enabled ademas de public_urgent_enabled.
